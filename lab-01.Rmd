...
**Not available. There are NA in the dataset.**
...
**the number of touristes at each attraction has a big difference, most of the attractions have little amount of tourists**
...
visitors %>%
  ...
  mutate(
    percentage_change = (n_2022-n_2021)/n_2021
    ) %>%
